          ...
          <Col lg={8} className="fullsheet">
              ...
              <Row>
                <Col md={12} className="about">
                  ...
                  <p>
                    I got my Bachleors Degree in Computer Science and Information Systems from Fort Lewis College. In high school and collage I worked mostly in C++ but since then I've worked on projects in many other languages. I have since taken some coding classes on iOS, Swift, and fullstack web development. I am currently a Teacher's Assistant for the Denver University Fullstack Web Development Bootcamp where I get to help students better understand the concepts and principles of web development.
                  </p>
                  <p>
                  ...
                  <p>
                    I have a heart for teaching others about the facinating things I've learned. Some of my favorite pastimes are playing with my kids, playing volleyball, working out, learning new things and writing about things I've learned to help me remember it better and share it with others. I would love to find a new job where I can create helpful and exciting programs and apps full time. 
                  </p>
                  <p>
